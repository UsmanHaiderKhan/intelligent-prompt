  ...
  return (
    <nav className="flex-between w-full mb-16 pt-3">
      <Link href="/" className="flex gap-2 flex-center">
        <Image src="/assets/images/logo.svg" alt="Intelligent-app" width={30} height={30} className="object-contain"/>
         <p className="logo_text">Intelligent Prompt</p>  
      </Link>
      ...
      <div className="sm:hidden flex relative">
        ...
        <div className="flex"> 
            ...
            {toggleDropDow && (<div className="dropdown">
